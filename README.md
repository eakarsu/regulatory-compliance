...
This standalone application consolidates source-backed capabilities into 226 optimized features, including 19 visible data-backed or AI-enabled views. Its public demo SQLite database contains 300 sanitized source rows across 20 imported tables and 120 operational workflow records.
...
- `AICannabisCultivationCompliance`
- `AIPermitZoningCompliance`
